...
\usepackage{float}  % Per [H], forzare posizione figura

\usepackage[T1]{fontenc}

%Per cerchi colorati nella tabella in wrapUp
\newcommand*\emptycirc[1][1ex]{\tikz\draw[thick, red] (0,0) circle (#1);} 
\newcommand*\halfcirc[1][1ex]{
  \begin{tikzpicture}
  \draw[fill=orange!80!black, orange!80!black] (0,0)-- (90:#1) arc (90:270:#1) -- cycle ;
  \draw[thick, orange!80!black] (0,0) circle (#1);
  \end{tikzpicture}}
\newcommand*\fullcirc[1][1ex]{\tikz\fill[fill=green!50!black, green!50!black] (0,0) circle (#1);}