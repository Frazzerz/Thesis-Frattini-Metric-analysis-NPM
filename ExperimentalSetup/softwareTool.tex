...
the tool first determines the type of the file using Magika, 
...
for instance to match both 0x and 0X in Unique Hexadecimal values.
To find all matches of a pattern within a file's content, 
the tool uses the finditer method on the compiled pattern,
which returns an iteretor over all matches, and is more memory-efficient than collecting all results at once.
