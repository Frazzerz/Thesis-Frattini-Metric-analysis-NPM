...
Then, the tool checks whether the detected file type is in a predefined whitelist.
...
for instance to match both \texttt{0x} and \texttt{0X} in Unique Hexadecimal values.
