...
A package is flagged as suspicious when data flows between sources and sinks without proper sanitization in between.
...
When dangerous behavior is hidden behind encoding or identifier-renaming techniques,
...
Dynamic analysis overcomes the obfuscation limitation by executing the package in a controlled environment and observing its runtime behaviour. 
...
can simple metrics derived from the whitespace and character distribution of files detect \ac{BST} and \ac{HUT} attacks?
...
to make implementation appear different to a human reviewer than what is actually parsed and executed. 
