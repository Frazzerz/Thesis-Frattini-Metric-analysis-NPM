...
\cref{sec:MLAndLLM} describes in detail the two most representative LLM-based tools, \texttt{SpiderScan} and \texttt{SocketAI}, 
...
\textcite{zahan2025leveraginglargelanguagemodels} used thirty-nine custom \texttt{CodeQL} rules, 
originally developed by \textcite{unknown}, to flag malicious JavaScript patterns in \ac{NPM} packages,
...
a malware detection workflow leveraging \texttt{GPT-3} and \texttt{GPT-4}. 
...
\textcite{weissberg2025llm} study the relationship between software metrics and vulnerabilities, 
