...
Among the packages in the \emph{Goodware} dataset, several exhibit outlier values for one or more versions. 
...
Understanding these patterns is essential to distinguish legitimate anomalies from malicious injections when evaluating the \emph{Malware} dataset in \cref{subsec:analysisPackageSizeComparisonMalware}.
...
making this the heaviest tarball in the entire \emph{Goodware} dataset.
...
In its first three versions, the size was 15.5~MB, and from point~1 in \cref{fig:fig1PackageSizeDecreasing}, 
...
this increase is insufficient to place the compromised versions among the outlier values of the \emph{Goodware} dataset.
...
This increase is modest relative to the size range of the \emph{Goodware} dataset, 
