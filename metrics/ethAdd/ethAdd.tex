...
to ensure that the address is neither preceded nor followed by alphanumeric characters,
...
this solution also correctly handles the typical path separators (\texttt{/} and \texttt{-}).
