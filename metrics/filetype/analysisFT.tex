...
\begin{itemize}
    ...
    This is because an \ac{NPM} package must contain a package.json file in order to be published to the \ac{NPM} registry~\cite{npmdocs2026npmdocumentation}.
    ...
    \begin{itemize}
        ...
        \item \textbf{Purpose of the package}. Some packages do not contain executable logic; their utility lies in the data they provide.
    ...
    \item Other prevalent file types include markdown files, typically README and CHANGELOG,
    and text files, usually LICENSE. Small variations in their presence are due to maintainer forgetfulness.
...
The extensions shown in \cref{fig:fig1RareFileTypes} (55 in total) are outliers, representing file types present in very few packages.
...
\begin{itemize}
    ...
    Specifically, it includes \texttt{windows-kill.exe} to ensure singal event (like CTRL+C) work correctly on Windows, 
