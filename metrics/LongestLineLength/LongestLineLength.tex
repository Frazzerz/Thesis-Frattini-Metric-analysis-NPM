...
As indicated at {\large\ding{172}} in \cref{fig:fig1LLLTrend}, 
...
but at {\large\ding{173}} in \cref{fig:fig1LLLTrend} the metric increased to 2,188,784 characters, making it an outlier for all subsequent releases.
...
remains within the upper confidence interval bound established in the goodware dataset.
