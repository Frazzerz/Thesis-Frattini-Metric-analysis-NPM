...
it is possible to effectively detect the attack C (Shai-Hulud~1.0 \cref{sec:analysisHexAttackC}) 
and the attack D (Shai-Hulud~2.0 \cref{sec:analysisHexAttackD}), because in both cases the 
