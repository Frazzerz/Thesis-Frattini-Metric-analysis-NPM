...
In the attack A (\cref{sec:attackA}), the attacker included a plain text file, 
...
In the attack C (\cref{sec:attackC}), the attacker introduced a malicious file named \texttt{bundle.js}  
...
Finally, in the attack D (\cref{sec:attackD}), the attacker introduces a malicious file named 
