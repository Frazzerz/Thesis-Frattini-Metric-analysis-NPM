...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Attacks/CompromisedPackagePayload.pdf}
...
and large-scale credential exfiltration with worm-like self-propagation (\cref{sec:attackC}, \cref{sec:attackD}).