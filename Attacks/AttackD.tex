...
inserting into the tarball a new installation file setup\_bun.js
and a file bun\_environment.js.

The first file mimics the code related to the Bun configuration and 
calls the second file bun\_environment.js.
...
once the script (bun\_environment.js) is started,
