...
\section{Heatmap of file types in tarballs}
\label{sec:realWorldAnalysisFileTypes}
...
\section{Real-world packages analysis for the unique hexadecimal values (no duplicates) metric}
\label{sec:realWorldAnalysisHexUnique}
...
\section{Real-world packages analysis for the unique hexadecimal values (no duplicates) metric with malicious packages versions}\label{sec:realWorldAnalysisHexUniqueMalicious}
