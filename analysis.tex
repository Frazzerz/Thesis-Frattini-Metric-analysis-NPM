...
Infatti questi 10 pacchetti hanno un numero di valori esadecimali unici tale da 
...
La directory conteneva svariati file, tra cui un file JavaScript bundle generato, 
...
il pacchetto aveva 256 valori esadecimali unici, rappresentanti appunto i valori della tabella CRC.
...
e successivamente dalla versione 2.0.3 (-4 nel grafico \ref{fig:hex_unique_plot1}),
...
Invece il pacchetto aws-sdk, libreria ufficiale per interagire con i servizi cloud AWS,
rappresenta nel grafico \ref{fig:hex_unique_plot1} 
...
nel capitolo relativo al threat modeling, fossero individuabili tramite questa metrica.

Affinchè siano individuabili, le versioni malevole devono 
...
Non sono più presenti le linee colorate che rappresentano i pacchetti evidenziati precedentemente,
e la mediana, in quanto non più necessari per lo scopo di questo grafico \ref{fig:hex_unique_plot2}.
...
Invece le croci rosse nel grafico \ref{fig:hex_unique_plot2} 
rappresentano le versioni malevole.

Come discusso nel capitolo metriche, ho scelto di considerare questa metrica 
...
\begin{itemize}
    ...
    \item \textbf{Shai-Hulud 1.0 (3rd attack):}   
        ...
        e pertanto il numero di valori esadecimali unici non è aumentato in modo significativo.
    ...
    \item \textbf{Shai-Hulud 2.0 (4th attack):}
        ...
        i pacchetti con la versione compromessa, le linee colorate puntinate,
