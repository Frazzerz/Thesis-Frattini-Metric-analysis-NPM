...
%\include{metrics/filetype}
%\include{metrics/packageSize}
%\include{metrics/LongestLineLenght}
%\include{metrics/hex}
%\include{metrics/sensitiveKeywords}
%\include{metrics/cryptoAdd}
